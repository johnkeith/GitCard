...
$(function () {
  ...
  $("a.edit-profile-btn").on("click", function() {
    $("body").append("<div class=\"long-loader\"><div class=\"loader-spinner lead\">" +
      "<i class=\"fa fa-spinner fa-spin\"></i><br>Hold on, we need to fetch" +  
      " your repos...</div></div>");
